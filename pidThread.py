...
class PidThread(Thread):
    ...
    def __init__(self,robot,input,baseSpeed:int=60):
        self.input = input
        self.robot=robot
    ...
    def run(self):
        ...
        while 1:
            ...
            debug(level=2, showOnBrick=False,msg="Linefollow thread: stear {} speed {} input {} target {} error {} {}".format(self.stear, spd, input, self.targetInput,abs(input - self.linksInput),abs(input - self.rechtsInput)))
